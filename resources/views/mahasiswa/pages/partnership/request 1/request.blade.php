...
<div class=" my-10 p-8 rounded-3xl shadow-2xl bg-white">
    ...
    <form action="{{ route('partnership.store', ['id' => $detail->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class=" mt-8 grid lg:grid-cols-2 gap-4">
            ...
            <div>
                <label for="nama" class="text-label-form">Nama<span class="text-red-500 mx-1">*</span></label>
            ...
            <div>
                <label for="email" class="text-label-form">Email<span class="text-red-500 mx-1">*</span></label>
            ...
            <div>
                <label for="job" class="text-label-form">Universitas<span class="text-red-500 mx-1">*</span></label>
            ...
            <div>
                <label for="telpon" class="text-label-form">Nomor Telpon<span class="text-red-500 mx-1">*</span></label>
            ...
            <div>
                <label for="deskripsi" class="text-label-form">Deskripsi Acara<span class="text-red-500 mx-1">*</span></label>
            ...
            <div class="col-span-full">
                <label for="deskripsi" class="text-label-form">Proposal<span class="text-red-500 mx-1">*</span></label>
        ...
        <div class="space-x-4 mt-8">
            ...
            <button type="button" onclick="window.location.href='/sponsor'" class="px-10 py-4  bg-white border border-gray-200 text-gray-600 rounded-md hover:bg-gray-100 active:bg-gray-200 disabled:opacity-50">
                Cancel
            </button>
        </div>
    </form>
