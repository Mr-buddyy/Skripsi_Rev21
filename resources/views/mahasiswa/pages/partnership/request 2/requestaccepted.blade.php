...
<div class=" my-10 p-8 rounded-3xl shadow-2xl bg-white">
    ...
    <div class="flex flex-col mt-8 gap-4">
        ...
        <form action="{{ route('sponsor.upload', ['id' => $detail->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-span-full">
                <label for="photo" class="block text-sm font-medium leading-6 text-gray-900">Upload MOU<span class="text-red-500 mx-1">*</span></label>
    ...
    @else
    <p class="text-gray-600 mt-6">Permintaan kerja sama anda telah diterima oleh pihak {{ $partnership->sponsor->profile->nama_perusahaan ?? '-' }}. Mohon tunggu untuk kelanjutannya</p>
    @endif
