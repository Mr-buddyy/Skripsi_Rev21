...
<header class="">
        ...
        <div class="flex items-center justify-between h-16 lg:h-20">
            <div class="flex-shrink-0">
                <a href="#" title="" class="flex">
                    <img class="w-auto h-12" src="{{asset('assets/img/icon2.png')}}" alt="" />
                </a>
            </div>

            <button type="button" class="lg:hidden" id="mobile-menu-button">
            ...
            <div class="sm:hidden md:hidden ml-auto lg:flex lg:items-center lg:justify-center lg:space-x-10">
                <a href="/" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80">
                    Beranda </a>

                <a href="/sponsor" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80">
                    Sponsor </a>

                <a href="/about" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80">
                    Tentang </a>

                <a href="/contact" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80">
                    Kontak </a>
                            ...
                            <a class="ease-soft py-1.2 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 hover:bg-gray-200 hover:text-slate-700 lg:transition-colors" href="/profile">
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex flex-row justify-center">
                                        <h6 class="mb-1 font-semibold leading-normal text-sm">{{ auth()->user()->username}}</h6>
                                    </div>
                                </div>
                            </a>
                        </li>
    ...
    <!-- Tambahkan div untuk menu pada layar kecil -->
    <div class="lg:hidden flex flex-row justify-center text-center" id="mobile-menu">
        <div class="flex flex-col">
            <a href="/" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80">
                Beranda </a>
            <a href="sponsor" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80">
            ...
            <a class="relative flex items-center pr-2">
                ...
                <ul dropdown-menu class="z-999 mx-5 text-sm transform-dropdown lg:shadow-soft-3xl duration-250 min-w-44 pointer-events-none absolute right-0 top-0 origin-top list-none rounded-lg border-0 border-solid border-transparent bg-white bg-clip-padding px-2 py-4 text-left text-slate-500 opacity-0 transition-all before:text-white sm:-mr-6 lg:absolute lg:right-0 lg:left-auto lg:mt-2 lg:block lg:cursor-pointer">
                    <!-- add show class on dropdown open js -->
                    <li class="relative mb-2 ">
                        <a class="ease-soft py-1.2 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 hover:bg-gray-200 hover:text-slate-700 lg:transition-colors" href="/profile">
                            <div class="flex flex-col">
