        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="col-span-full">
                ...
                <div class="mt-2 flex items-center gap-x-3">
                    ...
                    <input type="file" class="form-control" name="photo_perusahaan">
                    <!-- <button type="button" class="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Change</button> -->
                </div>
                @error('photo_account')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="col-span-3">
                    ...
                    <div class="mt-2">
                        <textarea id="alamat" name="alamat" rows="3" class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-blue-600 caret-blue-600"></textarea>
                    </div>
